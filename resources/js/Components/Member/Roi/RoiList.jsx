...
export default function RoiList({ auth }) {
    const { getMyRoiList } = useWallet();
    const [myRoiObject, setMyRoiObject] = useState(null);
    const [myRoi, setMyRoi] = useState([]);
    ...
    const fetchData = async (offset) => {
        const data = await getMyRoiList(offset);
